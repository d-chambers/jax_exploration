...
def wave_eqn(u, t, dx, dy, c):
    d2udx2 = (jnp.roll(u, -1, axis=1) - 2 * u + jnp.roll(u, 1, axis=1)) / dx**2
    d2udy2 = (jnp.roll(u, -1, axis=0) - 2 * u + jnp.roll(u, 1, axis=0)) / dy**2
    d2udt2 = c**2 * (d2udx2 + d2udy2)
    return d2udt2
...
@jit
def time_step(u, t):
    u_next = u + dt * grad(wave_eqn)(u, t, dx, dy, c)
    return u_next, t + dt
